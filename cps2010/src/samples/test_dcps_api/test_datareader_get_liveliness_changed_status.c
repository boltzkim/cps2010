...
{
	LivelinessChangedStatus* p_local_status;
	int32_t alive_count = p_status->alive_count;
	int32_t alive_count_change = p_status->alive_count_change;
	int32_t not_alive_count = p_status->not_alive_count;
	int32_t not_alive_count_change = p_status->not_alive_count_change;
	InstanceHandle_t last_publication_handle = p_status->last_publication_handle;

	p_local_status = (LivelinessChangedStatus*)calloc(1, sizeof(LivelinessChangedStatus));

	p_datareader->get_liveliness_changed_status(p_datareader, p_local_status);

	compare_variables("alive_count", p_local_status->alive_count, alive_count);
	compare_variables("alive_count_change", p_local_status->alive_count_change, alive_count_change);
	compare_variables("not_alive_count", p_local_status->not_alive_count, not_alive_count);
	compare_variables("not_alive_count_change", p_local_status->not_alive_count_change, not_alive_count_change);
	compare_variables("last_publication_handle", p_local_status->last_publication_handle, last_publication_handle);
