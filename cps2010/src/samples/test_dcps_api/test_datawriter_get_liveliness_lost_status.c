...
{
	LivelinessLostStatus* p_local_status;
	int32_t total_count = p_status->total_count;
	int32_t total_count_change = p_status->total_count_change;

	p_local_status = (LivelinessLostStatus*)calloc(1, sizeof(LivelinessLostStatus));

	p_datawriter->get_liveliness_lost_status(p_datawriter, p_local_status);
