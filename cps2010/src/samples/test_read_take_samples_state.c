...
//	if(p_datareader->i_message_order % 10 != 0)
//		return;
	
//	p_foo_datareader->read(p_foo_datareader, &foo_seq, &sample_info_seq, 10, ANY_SAMPLE_STATE, ANY_VIEW_STATE, ANY_INSTANCE_STATE);
	if(p_datareader->i_message_order < 2)
	p_foo_datareader->read(p_foo_datareader, &foo_seq, &sample_info_seq, 10, ANY_SAMPLE_STATE, NEW_VIEW_STATE, ANY_INSTANCE_STATE);
	else
	p_foo_datareader->read(p_foo_datareader, &foo_seq, &sample_info_seq, 10, ANY_SAMPLE_STATE, NOT_NEW_VIEW_STATE, ANY_INSTANCE_STATE);
//	p_foo_datareader->take(p_foo_datareader, &foo_seq, &sample_info_seq, 10, ANY_SAMPLE_STATE, ANY_VIEW_STATE, ANY_INSTANCE_STATE);

//	p_foo_datareader->read(p_foo_datareader, &foo_seq, &sample_info_seq, 10, ANY_SAMPLE_STATE, ANY_VIEW_STATE, ALIVE_INSTANCE_STATE);
//	p_foo_datareader->read(p_foo_datareader, &foo_seq, &sample_info_seq, 10, ANY_SAMPLE_STATE, ANY_VIEW_STATE, NOT_ALIVE_DISPOSED_INSTANCE_STATE);
//	p_foo_datareader->read(p_foo_datareader, &foo_seq, &sample_info_seq, 10, ANY_SAMPLE_STATE, ANY_VIEW_STATE, NOT_ALIVE_NO_WRITERS_INSTANCE_STATE);
